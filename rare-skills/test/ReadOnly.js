...
describe(NAME, function () {
  ...
  describe("exploit", async function () {
    ...
    it('conduct your attack here', async function () {
      const PoolAttackerContractFactory = await ethers.getContractFactory('PoolAttacker');
      const initialStake = ethers.utils.parseEther('1.1'); // amount greater than 1 ETH
      const poolAttackerContract = await PoolAttackerContractFactory.deploy(
          readOnlyContract.address,
      ...
      const attackTx = await poolAttackerContract.attack();
      await attackTx.wait();
  });
